...
export class ProjetService {
    ...
    //faire appel a un api qui renvoie un projet en fonction de lid
    //rajoute par moiSina: Observable<Projet> retour = find(id);
    //puis balancer ce projet
    queryTachesParProjet(projet: Projet): Observable<ResponseWrapper> {
        return this.http.get(`${SERVER_API_URL}api/taches/projet/${projet.id}`, {
    ...
    queryTachesParProjetBIS(projet: Projet): Observable<ResponseWrapper> {
        return this.http.get(`${SERVER_API_URL}api/taches/projetBIS/${projet.id}`, {
    ...
    // recupererTousTacheAvecDonnees(idProjet: number): Observable<ResponseWrapper> {
    //     return this.http.get(`${SERVER_API_URL}api/taches/recupererTousTacheAvecDonnees/${idProjet}`, {
    //
    //     })
    //         .map((res: Response) => this.convertResponse(res));
    // }
    ...
    /*
     queryTachesParProjet(projet: Projet): Observable<ResponseWrapper> {
     return this.http.post(`${SERVER_API_URL}api/taches/projet/`, {
     projet : projet
     })
     .map((res: Response) => this.convertResponse(res));
     }
    ...
    private convert(projet: Projet): Projet {
        ...
        copy.debutProjet = this.dateUtils
            .convertLocalDateToServer(projet.debutProjet);
        copy.finProjet = this.dateUtils
            .convertLocalDateToServer(projet.finProjet);
        return copy;
    }
...
// cree par moiSina
//     sumJoursVendus(idProjet: number): Observable<ResponseWrapper> {
//         return this.http.get(`${SERVER_API_URL}api/taches/sumjoursvendus/${idProjet}`, {
//
//         })
//             .map((res: Response) => this.convertResponse(res));
//     }
...
export var films = [
    { title: 'The Shawshank Redemption  001', year: 1994, rating: 9.2, director: 'Frank Darabont',

        description: [
            { title: 'The Shawshank Redemption 1', year: 1994, rating: 9.2, director: 'Frank Darabont'},
            { title: 'The Shawshank Redemption 2', year: 1994, rating: 9.2, director: 'Frank Darabont'},
            { title: 'The Shawshank Redemption 3', year: 1994, rating: 9.2, director: 'Frank Darabont'}
        ]
    },
    { title: 'The Shawshank Redemption  002', year: 1994, rating: 9.2, director: 'Frank Darabont',

        description: [
            { title: 'The Shawshank Redemption 8', year: 1994, rating: 9.2, director: 'Frank Darabont'},
            { title: 'The Shawshank Redemption 9', year: 1994, rating: 9.2, director: 'Frank Darabont'},
            { title: 'The Shawshank Redemption 10', year: 1994, rating: 9.2, director: 'Frank Darabont'}
        ]
    },
];
